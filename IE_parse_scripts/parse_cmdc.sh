...
awk -v pattern1="^$todayYear\\/$todayMonth\\/$todayDay.*CMDC.request" -v pattern1="^$todayYear\\/$todayMonth\\/$todayDay.*CMDC.request" 'BEGIN{i=1} $0 ~pattern2 {i=1}; $0 ~ pattern1 {i=0}i' > $rawOrderedDataFile2
